        ...
        <div class="flex max-w-7xl mx-auto">
            ...
            <main class="flex-1 p-8">
                <div class="mb-6 flex items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">➕ Create Electricity Schedule</h2>
                        <p class="text-gray-500 mt-1">Add a new zone-wise electricity schedule</p>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow p-8 max-w-2xl">
                    <form action="{{ route('admin.schedule.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" id="zone" name="zone" value="{{ old('zone') }}"
                                ...
                                class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent @error('zone') border-red-400 @enderror"
                                required>
                            @error('zone')
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4"
                                ...
                                class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 resize-none">{{ old('description') }}</textarea>
                        </div>
